...
def get_first_font_file(fonts_dir: pathlib.Path, relative_only: bool = False) -> str | pathlib.Path:
...
def get_available_fonts_list(fonts_dir: pathlib.Path, relative_only: bool = False) -> list[str] | list[pathlib.Path]:
